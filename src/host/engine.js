...
import { applyManagedToggleRows, readManagedToggleRows, } from './patch-editor.ts';
import { buildEntryEvidence, capabilityOf, computeRevision, createEvidenceSession, fileDigest, readProfileManifestView, } from './profile-evidence.ts';
import { PluginLifecycleTokenStore } from './token-store.ts';
import { PluginLifecycleOperationStore } from './operation-store.ts';
import { clearSettledPendingRemovals, readPendingRemovals, runUninstallTransaction, } from './uninstall.ts';
