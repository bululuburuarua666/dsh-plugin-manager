...
export class LifecycleEngine {
    ...
    preview(request) {
        ...
        if (request.action === 'uninstall' && !capability.canUninstall) {
            throw lifecycleFailure(blockReasonToCode(capability.uninstallBlockReason ?? 'not-direct-dependency'), 'the package may not be uninstalled through this surface');
        }
